...
ap.add_argument("--contextual-model", required=False, default="none",
                help="Contextual-prefix backend spec, e.g. 'none', 'echo', 'ollama:qwen3.6:35b-a3b-nvfp4', 'claude-code:claude-haiku-4-5', 'anthropic:claude-haiku-4-5'. Prefixes are retried once if the backend returns the wrong number of them.")
